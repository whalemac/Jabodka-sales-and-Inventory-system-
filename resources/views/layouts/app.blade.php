            ...
            <div class="flex items-center justify-between h-14 md:h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <nav class="hidden lg:flex items-center gap-0.5 mr-2">
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('dashboard') }}" class="nav-tab {{ request()->routeIs('dashboard') ? 'nav-tab-active' : '' }}">Dashboard</a>
                            <a href="{{ route('admin.walk-in.index') }}" class="nav-tab {{ request()->routeIs('admin.walk-in.*') ? 'nav-tab-active' : '' }}">Walk-In</a>
                            <a href="{{ route('admin.online.index') }}" class="nav-tab {{ request()->routeIs('admin.online.*') ? 'nav-tab-active' : '' }}">Online</a>
                            <a href="{{ route('admin.products.index') }}" class="nav-tab {{ request()->routeIs('admin.products.*') ? 'nav-tab-active' : '' }}">Products</a>
                            <a href="{{ route('admin.stock.index') }}" class="nav-tab {{ request()->routeIs('admin.stock.*') ? 'nav-tab-active' : '' }}">Stock</a>
                            <a href="{{ route('admin.consignment.index') }}" class="nav-tab {{ request()->routeIs('admin.consignment.*') ? 'nav-tab-active' : '' }}">Consignment</a>
                            <a href="{{ route('admin.reports.index') }}" class="nav-tab {{ request()->routeIs('admin.reports.*') ? 'nav-tab-active' : '' }}">Reports</a>
                        @elseif(auth()->user()->isSuperAdmin())
                            <a href="{{ route('super.users.index') }}" class="nav-tab {{ request()->routeIs('super.users.*') ? 'nav-tab-active' : '' }}">Users</a>
                            <a href="{{ route('super.subscriptions.index') }}" class="nav-tab {{ request()->routeIs('super.subscriptions.*') ? 'nav-tab-active' : '' }}">Subscriptions</a>
                        @elseif(auth()->user()->isStaff())
                            <a href="{{ route('staff.production.index') }}" class="nav-tab {{ request()->routeIs('staff.production.*') ? 'nav-tab-active' : '' }}">Production Log</a>
                        @endif
                    </nav>
                    @endauth
...
<style>
    .nav-tab {
        @apply text-white/70 hover:text-white text-sm font-medium px-3 py-1.5 rounded-lg hover:bg-white/10 transition whitespace-nowrap;
    }
    .nav-tab-active {
